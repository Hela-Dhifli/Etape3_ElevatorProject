...
import org.paumard.elevator.student.EfficientElevator;
import org.paumard.elevator.student.HelpingEfficientElevator;
...
public class Building {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        EfficientElevator efficient = new EfficientElevator(ELEVATOR_CAPACITY, "efficient");
        Elevator helpingEfficient = new HelpingEfficientElevator(ELEVATOR_CAPACITY, "helpingEfficientElevator", efficient);
        Elevators elevators = new Elevators(List.of(efficient, helpingEfficient));
